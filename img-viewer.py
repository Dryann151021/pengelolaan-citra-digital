...
def slider_row(label, key, val_key, rng, default, res):
    ...
    return [
        sg.Text(label, size=(11, 1), font=("Helvetica", 9),
                text_color=TEXT_PRIMARY, background_color=BG_PANEL,
                pad=((8, 2), (3, 3))),
        sg.Slider(range=rng, default_value=default, resolution=res,
                  orientation="h", enable_events=True,
                  disable_number_display=True, size=(12, 14),
                  key=key, background_color=BG_PANEL,
                  pad=((0, 2), (3, 3))),
        sg.Text(f"{default}", size=(5, 1), key=val_key,
                font=("Helvetica", 9, "bold"), text_color=ACCENT_BLUE,
                background_color=BG_PANEL, justification="right",
                pad=((0, 8), (3, 3))),
    ]


def filter_btn(label, key, pad=((8, 4), (3, 3))):
    return sg.Button(label, key=key, size=(11, 1),
                     button_color=(TEXT_PRIMARY, BG_CARD),
                     border_width=0, pad=pad)


def section_label(text):
    return sg.Text(text, font=("Helvetica", 8, "bold"),
                   text_color=TEXT_MUTED, background_color=BG_PANEL,
                   pad=((8, 8), (10, 5)))
...
left_sidebar = [
    [section_label("📁  FILES")],
    [sg.In(size=(17, 1), key="ImgFolder", enable_events=True,
           background_color=BG_CARD, text_color=TEXT_PRIMARY,
           pad=((8, 0), (0, 4))),
     sg.FolderBrowse(button_color=(TEXT_PRIMARY, ACCENT_BLUE),
                     pad=((2, 8), (0, 4)))],
    [sg.Listbox(values=[], enable_events=True, size=(24, 13),
                key="ImgList", background_color=BG_CARD,
                text_color=TEXT_PRIMARY,
                highlight_background_color=ACCENT_BLUE,
                highlight_text_color="#FFFFFF",
                pad=((8, 8), (0, 8)), no_scrollbar=False)],
    [sg.HorizontalSeparator(color=BORDER, pad=((8, 8), (4, 4)))],
    [section_label("📊  INFO")],
    [sg.Text("—", size=(22, 1), key="ImgSize",
             font=("Helvetica", 9), text_color=TEXT_PRIMARY,
             background_color=BG_PANEL, pad=((8, 8), (2, 2)))],
    [sg.Text("—", size=(22, 1), key="ImgColorDepth",
             font=("Helvetica", 9), text_color=TEXT_PRIMARY,
             background_color=BG_PANEL, pad=((8, 8), (2, 8)))],
]

# Center Panel
before_col = sg.Column([
    [sg.Text("BEFORE", font=("Helvetica", 8, "bold"),
             text_color=TEXT_MUTED, background_color=BG_DARK,
             justification="center", expand_x=True)],
    [sg.Image(key="ImgInputViewer", background_color=BG_DARK,
              pad=((8, 8), (4, 4)))],
], background_color=BG_DARK, element_justification="center", expand_x=True, expand_y=True)

after_col = sg.Column([
    [sg.Text("AFTER", font=("Helvetica", 8, "bold"),
             text_color=ACCENT_BLUE, background_color=BG_DARK,
             justification="center", expand_x=True)],
    [sg.Image(key="ImgOutputViewer", background_color=BG_DARK,
              pad=((8, 8), (4, 4)))],
], background_color=BG_DARK, element_justification="center", expand_x=True, expand_y=True)
...
canvas_area = [
    ...
    [sg.Push(background_color=BG_DARK),
     sg.Text("", size=(60, 1), key="ImgProcessingType",
             font=("Helvetica", 9, "bold"), text_color=ACCENT_BLUE,
             background_color=BG_DARK, justification="center"),
     sg.Push(background_color=BG_DARK)],
    [sg.Push(background_color=BG_DARK),
     sg.Text("", size=(70, 1), key="FilepathImgInput",
             font=("Helvetica", 8), text_color=TEXT_MUTED,
             background_color=BG_DARK, justification="center"),
     sg.Push(background_color=BG_DARK)],
]
...
right_panel = [
    ...
    [filter_btn("Grayscale",  "ImgGrayscale"),  filter_btn("Negative",  "ImgNegative",  pad=((4, 8), (3, 3)))],
    [filter_btn("Edge Detect","ImgEdgeDetect"), filter_btn("Vintage",   "ImgVintage",   pad=((4, 8), (3, 3)))],
    [filter_btn("Emboss",     "ImgEmboss"), filter_btn("Posterize",  "ImgPosterize", pad=((4, 8), (3, 3)))],    
    [filter_btn("Dilation",   "ImgDilation"), filter_btn("Erosion",   "ImgErosion",   pad=((4, 8), (3, 3)))],
    [sg.HorizontalSeparator(color=BORDER, pad=((8, 8), (4, 4)))],
    [section_label("✂  CROP  (px)")],
    [sg.Text("X", size=(2, 1), background_color=BG_PANEL,
             text_color=TEXT_MUTED, pad=((8, 0), (2, 2))),
     sg.Input("0", size=(5, 1), key="CropX", background_color=BG_CARD,
               text_color=TEXT_PRIMARY),
     sg.Text("Y", size=(2, 1), background_color=BG_PANEL,
             text_color=TEXT_MUTED, pad=((4, 0), (2, 2))),
     sg.Input("0", size=(5, 1), key="CropY", background_color=BG_CARD,
               text_color=TEXT_PRIMARY)],
    [sg.Text("W", size=(2, 1), background_color=BG_PANEL,
             text_color=TEXT_MUTED, pad=((8, 0), (2, 2))),
     sg.Input("100", size=(5, 1), key="CropW", background_color=BG_CARD,
               text_color=TEXT_PRIMARY),
     sg.Text("H", size=(2, 1), background_color=BG_PANEL,
             text_color=TEXT_MUTED, pad=((4, 0), (2, 2))),
     sg.Input("100", size=(5, 1), key="CropH", background_color=BG_CARD,
               text_color=TEXT_PRIMARY)],
    [sg.Button("✂  Crop Image", key="ImgCrop", size=(20, 1),
               button_color=(TEXT_PRIMARY, BG_CARD), border_width=0,
               pad=((8, 8), (8, 10)))],
    [sg.HorizontalSeparator(color=BORDER, pad=((8, 8), (8, 4)))],
...
# Top Toolbar
toolbar = [
    sg.Text("🖼  Metamorfo", font=("Helvetica", 13, "bold"),
            text_color=ACCENT_BLUE, background_color=BG_DARK,
            pad=((16, 8), (10, 10))),
    sg.Push(background_color=BG_DARK),
    sg.Button("  💾  Save  ", key="ImgSave",
              button_color=(BG_DARK, ACCENT_GREEN),
              font=("Helvetica", 10, "bold"), border_width=0,
              pad=((4, 4), (8, 8))),
    sg.Button("  ↺  Reset  ", key="ImgReset",
...
layout = [
    ...
    [
        sg.Column(left_sidebar, background_color=BG_PANEL,
                  vertical_alignment="top", size=(215, 350)),
        sg.VSeparator(color=BORDER),
        sg.Column(canvas_area, background_color=BG_DARK,
                  element_justification="center",
                  vertical_alignment="top", expand_x=True, expand_y=True),
        sg.VSeparator(color=BORDER),
        sg.Column(right_panel, background_color=BG_PANEL,
                  vertical_alignment="top", size=(250, 650)),
    ],
]
...
while True:
        ...
        if curr_size != last_win_size:
            ...
            try:
                ...
                if img_output is not None:
                    out_img = img_output.convert("RGB") if img_output.mode not in ("RGB", "L") else img_output
    ...
    # 3D Rotate
        ...
        try:
            ...
            window["ImgProcessingType"].update(f"3D Rotate  Tilt {ax:+d}°  Pan {ay:+d}°")
    ...
    # Save
        ...
        try:
            ...
            if image_to_save is None:
                sg.popup_error("Tidak ada gambar yang dimuat untuk disimpan!", title="Error",
                               background_color=BG_CARD, text_color=ACCENT_RED)
                continue
            ...
            if save_path:
                ...
                sg.popup_ok(f"Gambar berhasil disimpan:\n{save_path}",
                            title="Saved!", background_color=BG_CARD,
                            text_color=TEXT_PRIMARY)
        except Exception as e:
            sg.popup_error(f"Gagal menyimpan: {e}", title="Error",
                           background_color=BG_CARD, text_color=ACCENT_RED)
    ...
    # Crop
        ...
        try:
            ...
            sg.popup_error("Input crop harus berupa angka!", title="Error",
                           background_color=BG_CARD, text_color=ACCENT_RED)
        except Exception as e:
            sg.popup_error(f"Gagal crop: {e}", title="Error",
                           background_color=BG_CARD, text_color=ACCENT_RED)
